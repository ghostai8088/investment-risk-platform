...
| REQ | Title | CAP | Business purpose | Functional | Data | Calc | Test | Acceptance | Status |
|---|---|---|---|---|---|---|---|---|---|
| REQ-MDG-001 | Model inventory & versioning | 12.1/12.2 | Single register of models | Register every model/version + assumptions/limitations | `model`, `model_version` (IA) | — | Inventory-binding test | No calc runs without an inventory entry (BR-3) | Draft |
