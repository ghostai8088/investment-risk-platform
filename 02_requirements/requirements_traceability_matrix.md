...
|---|---|---|---|---|---|---|---|---|---|---|---|
| REQ-PPM-001 | 1.1 | P-PM,P-ADM | 1L/Plat | P1 | BX-AUD | BX-ENT | — | — | CTRL-001/005/011 | FW-ENT, FW-AUD, FW-TMP | Draft |
...
| REQ-SMR-004 | 2.4/2.5a | P-DS,P-RA | Plat | P1 | BX-AUD | BX-ENT | BX-LIN | — | CTRL-004/017 | FW-TMP, QS-10/11 | **In-Progress (P1B-1, calendar partial):** `calendar`+`calendar_holiday` EV reference entity shipped (migration 0008, hybrid RLS, REFERENCE.* audited, MANUAL-source lineage); corporate_action=EV + roll math (QS-10/11) deferred to P1B-4/P1C |
