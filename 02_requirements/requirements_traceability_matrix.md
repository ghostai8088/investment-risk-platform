...
| REQ-MKT-001 | 5.1 | P-RA,P-RM | 1L/2L | P2 | BX-AUD | BX-ENT | BX-LIN | **Y** | CTRL-002/003/018/020 | FW-RUN, DEP-MREG, DEP-MGW, DEP-LIN, CAP-1/3 | Draft (P3-4 delivered the covariance SUBSTRATE only — sample factor covariance `covariance_result` ENT-051, migration `0025`; the REQ itself advances at P3-5 parametric VaR, not before) |
