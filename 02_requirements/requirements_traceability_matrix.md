...
| REQ-PPM-004 | 1.5 | P-RA,P-RM | 1L/2L | P1 | BX-AUD | BX-ENT | BX-LIN | — | CTRL-006/018 | FW-RUN, DEP-LIN, CAP-1 | In-Progress (P2-0 ratified 2026-06-26; AD-014 `dataset_snapshot` ENT-049/050 prereq → P2-1; `calculation_run`-bound aggregation → P2-3) |
