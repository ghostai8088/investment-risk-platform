"""PostgreSQL migration-mechanics proofs for CC-2 ``pacing_projection_result`` (ENT-059, IA).

Catalog-introspection only (no FK-parent seeding — the binder + its full-chain end-to-end proof
land at demo stage 9): the symmetric FORCE-RLS policy (``USING == WITH CHECK == own-tenant``, NOT
...
_TABLE = "pacing_projection_result"
