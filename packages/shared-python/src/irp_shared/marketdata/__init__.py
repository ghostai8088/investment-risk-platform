...
from irp_shared.marketdata.benchmark_rates import (
...
from irp_shared.marketdata.proxy_mapping import (
    MANUAL_PROXY_SOURCE_CODE,
    MARKET_PROXY_MAPPING_CORRECTION_EVENT,
    MARKET_PROXY_MAPPING_CREATE_EVENT,
    MARKET_PROXY_MAPPING_UPDATE_EVENT,
