...
| | |
|---|---|
| **Status** | **RATIFIED 2026-07-14** — OQ-VW-1-1…7 approved as recommended (user: "Approved"; OQ-VW-1-5 staleness fork answered **A** — VW-1 delivers the generic ongoing-monitoring leg, the σ_e estimate-age gate is a named BT-2 ride-along). Implementation gated separately behind `vw_1_implementation_plan.md`. |
