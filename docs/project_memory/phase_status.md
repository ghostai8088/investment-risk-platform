...
| **P1B-3** instrument(+`instrument_terms` FR)/identifier_xref | NOT STARTED (planning only next, on approval) | — | — | — | the **first real FR/bitemporal** usage (`instrument_terms`); deterministic identifier resolution (OD-P1B-G) |
| **P1B-4 / P1B-5** corporate_action · ingestion mapping | NOT STARTED | — | — | — | later sub-slices |
...
- **P1B milestone: in progress** — P1B-1 + P1B-2 of 5 sub-slices done; next is P1B-3 (planning only, on approval).
...
AD-013-R1)** → **Legal-entity symmetric-RLS (REQ-SMR-002 / OD-P1B-D)** → downgrade base. Plus Backend (ruff
