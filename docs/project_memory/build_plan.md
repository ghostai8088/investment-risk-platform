...
**P1C closeout + P2 planning + governance ratification + P2-1 `dataset_snapshot` IMPLEMENTATION are DONE (see the P2 section below); next: P2-2 PLANNING ONLY (FX rates), on explicit approval.**
...
### P2 — Reproducibility foundation, market & private data, risk analytics — **P2-1 DELIVERED (P2-2 FX planning next)**
...
- **NEXT: P2-2 PLANNING** (FX rates — `fx_rate` FR, explicit pair direction, MID rate, configurable base + triangulation if ratified; a lookup, not analytics), on explicit approval. Then P2-2 implementation (separate approval), P2-3…P2-6, then P3+.
