...
> **As of 2026-06-24.** How Claude Code works on this project. Read with `current_state.md`, `next_actions.md`,
...
- Migrations sequential (head `0013_transaction`; next `0014`); `alembic check` is a drift gate
