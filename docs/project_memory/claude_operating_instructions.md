...
> **As of 2026-06-22.** How Claude Code works on this project. Read with `current_state.md`, `next_actions.md`,
...
- Migrations sequential (head `0011_corporate_action`; next `0012`); `alembic check` is a drift gate
