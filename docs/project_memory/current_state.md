...
> history. Read this first, then `10_delivery_backlog/delivery_roadmap.md` (the operative sequence) + `pm_1_decision_record.md` (the latest record), `next_actions.md`, and `claude_operating_instructions.md`. **As of HEAD
> `f5e16b6` / CI #137 green (PM-1 governed portfolio-return series, ENT-053 + migration 0031, Wave-2 slice 1; refreshed 2026-07-09).** Values that
