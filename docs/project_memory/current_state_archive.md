...
Moved out of `current_state.md` on 2026-07-30 (the user-ratified document-surface shrink): the
operative file had grown to 1,331 lines of stacked prior-truth blocks plus PA-0-era standing
sections banner-marked stale since 2026-07-11. Everything here is HISTORY, verbatim — where it
disagrees with `current_state.md`'s CURRENT TRUTH block or `delivery_roadmap.md`, THEY win.

**Second shrink, 2026-08-14.** Seven more prior-truth blocks moved here from
`current_state.md` (the 2026-08-08 Wave-17 planning-gate snapshot down to the 2026-07-29c
block), leaving the operative file with its current-truth block and the Wave-17 close sweep.
Verbatim, and in the order they stood. Same rule as the first shrink: where this disagrees
with `current_state.md`'s CURRENT TRUTH block or `delivery_roadmap.md`, THEY win.
